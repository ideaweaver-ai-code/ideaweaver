...
@crew.command('system_diagnostics')
@click.option('--openai-api-key', envvar='OPENAI_API_KEY', help='OpenAI API key')
...
def system_diagnostics(openai_api_key, verbose):
    ...
    \b
    Examples:
      ideaweaver crew system_diagnostics
      ideaweaver crew system_diagnostics --verbose
      ideaweaver crew system_diagnostics --openai-api-key your_api_key
    """
